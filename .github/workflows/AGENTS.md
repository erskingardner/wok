...
| `reliability.yml` | crate/soak changes on master/PR; weekly/manual | Three-minute canary; weekly one-hour Linux soak; portable Compose lab with result/archive tests |
