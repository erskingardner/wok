...
| `fips-message` | Very experimental Wok-independent FIPS V1 framing, handshake, chunking, bounded reassembly |
...
| `wok-fips` | Very experimental native FIPS datagram transport on Linux/FreeBSD/macOS |
...
- **Native FIPS is a very experimental Wok extension and is not production-ready.**
  Its API and wire contract may change incompatibly. It consumes the native
  datagram API,
